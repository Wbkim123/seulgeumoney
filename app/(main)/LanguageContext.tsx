...
const translations: Record<Language, Record<string, string>> = {
  ko: {
    ...
    'At least 1 uppercase letter': '대문자 1개 이상',
    'At least 1 number': '숫자 1개 이상',
    'At least 1 symbol': '특수문자 1개 이상',
    'Passwords match': '비밀번호 일치',
    'Change Password': '비밀번호 변경',
    'Please complete every password requirement.': '비밀번호 조건을 모두 충족해 주세요.',
    'Password changed successfully!': '비밀번호가 변경되었습니다!',
    'Unable to change password.': '비밀번호를 변경할 수 없습니다.',
    'Please log in before changing your password.': '비밀번호를 변경하려면 먼저 로그인해 주세요.',
    'The local admin password cannot be changed.': '로컬 관리자 비밀번호는 변경할 수 없습니다.',
    'Unable to find the current user.': '현재 사용자를 찾을 수 없습니다.',
  ...
  en: {
    ...
    'At least 1 symbol': 'At least 1 symbol',
    'Passwords match': 'Passwords match',
    'Change Password': 'Change Password',
    'Please complete every password requirement.': 'Please complete every password requirement.',
    'Password changed successfully!': 'Password changed successfully!',
    'Unable to change password.': 'Unable to change password.',
    'Please log in before changing your password.': 'Please log in before changing your password.',
    'The local admin password cannot be changed.': 'The local admin password cannot be changed.',
    'Unable to find the current user.': 'Unable to find the current user.',
