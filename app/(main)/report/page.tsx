...
export default function ReportPeriodPage() {
  ...
  const periodDetailsMap = useMemo(() => {
    ...
    for (let i = 0; i <= currentDayOfWeek; i++) {
      ...
      daily.push(`${shortMonths[d.getMonth()]} ${d.getDate()}`);
    }
    ...
    for (let w = 1; w <= 4; w++) {
      ...
      if (startOfPastWeek.getMonth() === endOfPastWeek.getMonth()) {
        weekly.push(`${shortMonths[startOfPastWeek.getMonth()]} ${startOfPastWeek.getDate()} - ${endOfPastWeek.getDate()}`);
      } else {
        weekly.push(`${shortMonths[startOfPastWeek.getMonth()]} ${startOfPastWeek.getDate()} - ${shortMonths[endOfPastWeek.getMonth()]} ${endOfPastWeek.getDate()}`);
      }
    }
    ...
    for (let i = 0; i < 5; i++) {
      ...
      monthly.push(`${longMonths[d.getMonth()]} ${d.getFullYear()}`);
    }
              ...
              <div className="flex flex-col gap-6">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="rounded-3xl bg-white p-6 shadow-[0_4px_20px_rgba(0,0,0,0.03)] ring-1 ring-black/5">
                    <div className="text-[13px] font-semibold text-slate-400">Total Spent</div>
                    <div className="mt-2 text-2xl font-extrabold text-slate-800">$ 145.50</div>
                  </div>
                  <div className="rounded-3xl bg-white p-6 shadow-[0_4px_20px_rgba(0,0,0,0.03)] ring-1 ring-black/5">
                    <div className="text-[13px] font-semibold text-slate-400">Your Budget</div>
                ...
                <div className="rounded-3xl bg-[#f0f5f0] p-6 ring-1 ring-[#98c195]/30">
                  <div className="mb-3 flex items-center gap-2">
                    ...
                    <h3 className="text-[15px] font-bold text-[#649566]">Insight</h3>
                  </div>
                ...
                <div className="rounded-3xl bg-white p-6 shadow-[0_4px_20px_rgba(0,0,0,0.03)] ring-1 ring-black/5">
                  <h3 className="mb-5 text-[15px] font-bold text-slate-700">Top Categories</h3>
                  ...
                  <div className="flex flex-col gap-6">
                    ...
                    <div>
                      <div className="mb-2 flex justify-between text-[14px] font-semibold">
                        <span className="text-slate-700">☕ Coffee</span>
