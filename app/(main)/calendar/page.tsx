...
export default function CalendarPage() {
  ...
  return (
    <>
      <div className="relative w-full max-w-[760px] mx-auto rounded-[32px] border border-border-custom/5 bg-surface/50 backdrop-blur-md px-6 py-10 sm:px-12 sm:py-12 shadow-[0_18px_50px_rgba(0,0,0,0.14)] animate-fade-in">
