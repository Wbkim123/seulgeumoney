...
import { getDemoVerificationCode, startPasswordReset } from '../authStorage';
...
export default function ForgotPasswordPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    try {
      ...
      router.push('/auth/forgotpw/verify');
    } catch (err) {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-background px-4">
      <div className="relative w-full max-w-sm pt-12 p-6 border border-border-custom/50 rounded-lg shadow-md bg-surface text-center">
        ...
        <h2 className="text-2xl font-bold mb-2 text-text-main">Find Password</h2>
